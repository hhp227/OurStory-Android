package com.hhp227.application.calendar;
...
public class ExtendedCalendarView extends RelativeLayout implements OnItemClickListener {
	...
	private void init() {
		...
		prev.setImageResource(R.drawable.ic_arrow_back_black_36dp);
		base.addView(prev);
		...
		next.setImageResource(R.drawable.ic_arrow_forward_black_36dp);
