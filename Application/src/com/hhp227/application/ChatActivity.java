...
public class ChatActivity extends Activity {
    ...
    private void sendMessage() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, endPoint, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    if(response.getBoolean("error") == false) {
                        JSONObject commentObj = response.getJSONObject("message");
                        ...
                        User user = new User(userId, null, userName, null, null, null, null, null);
                        ...
                        Toast.makeText(getApplicationContext(), "에러 : " + response.getString("message"), Toast.LENGTH_LONG).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.e(TAG, "Volley 에러 : " + error.getMessage() + ", code : " + networkResponse);
    ...
    private void fetchChatThread() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, endPoint + offSet, null, new Response.Listener<JSONObject>() {
                ...
                try {
                    if(response.getBoolean("error") == false) {
                        ...
                        for(int i = 0; i < commentsObj.length(); i++) {
                            ...
                            User user = new User(userId, null, userName, null, null, profile_Img, null, null);
