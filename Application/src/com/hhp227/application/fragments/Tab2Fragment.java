...
import com.hhp227.application.staggeredgrid.AlbumItem;
import com.hhp227.application.staggeredgrid.AlbumListAdapter;
...
public class Tab2Fragment extends BaseFragment implements AbsListView.OnScrollListener {
    ...
    private void fetchData() {
        ...
        JsonObjectRequest jsonReq = new JsonObjectRequest(Method.GET, URLs.URL_ALBUM + offSet, null, new Response.Listener<JSONObject>() {
