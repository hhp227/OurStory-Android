...
import com.hhp227.application.DetailActivity;
...
public class Tab1Fragment extends BaseFragment {
    ...
    private void fetchFeeds() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Method.GET, URL_FEEDS + offSet, null, new Response.Listener<JSONObject>() {
            @Override
