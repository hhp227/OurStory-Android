...
public class SangjuSeatFragment extends Fragment {
    ...
    private void fetchData() {
        String endPoint = URLs.URL_KNULIBRARY_SEAT.replace("{ID}", "2");
        AppController.getInstance().addToRequestQueue(new JsonObjectRequest(Request.Method.GET, endPoint, null, new Response.Listener<JSONObject>() {
            @Override
