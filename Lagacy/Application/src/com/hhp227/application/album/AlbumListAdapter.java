package com.hhp227.application.album;
...
public class AlbumListAdapter extends BaseAdapter {
    ...
    public AlbumListAdapter(Activity activity, List<AlbumItem> albumItems) {
        ...
        if (item.getImge() != null) {
            ...
            imgView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(PictureActivity.TYPE, PictureActivity.TYPEALBUM);
                    intent.putExtra(PictureActivity.IMAGE_URL, item.getImge());
